...
module.exports = function (grunt) {
	...
	grunt.initConfig({
		...
		project: {
			...
			js: {
				core: [
					// Core scripts that will get compiled into scripts.min.js
					"node_modules/dragula/dist/dragula.min.js",
					"<%= project.src %>/js/vendor/*.js",
					"<%= project.src %>/js/*.js",
					//'!<%= project.src %>/js/module.js'
				],
			},
		},
			...
			taskName: {
				...
				files: {
					src: [
						...
						// '<%= project.assets %>/file-to-apply-banner'
					],
				},
			},
		},
		...
		concat: {
			dev: {
				files: {
					"<%= project.assets %>/js/scripts.min.js": "<%= project.js.core %>",
					// '<%= project.assets %>/js/module.min.js': '<%= project.src %>/js/module.js'
				},
			},
			options: {
				stripBanners: true,
